...
function Pop()
{
  ...
  // const d_img= document.getElementById("image");
  // if(d_img!=null){
  // d_img.remove();
  // }
  for (let i = 0; i < MergedData1.length; i++) {
...
//   const elements = document.getElementsByClassName("box_1");
...
//MergedData1.push();
//const person = MergedData1[newEl];
...
MergedData1[i].region="other";
  ...
  //console.log(MergedData1[i].region)
}
